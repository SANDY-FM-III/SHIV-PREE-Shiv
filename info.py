...
BOT_TOKEN = environ.get('BOT_TOKEN', "6401749138:AAEmfOKfWGXKIE4MSxufU8mQytlLSeGfv6I")
...
NOR_IMG = environ.get("NOR_IMG", "hthttps://graph.org/file/3eca1e6671cd4ac9e876f-fd7d683f7dffefac77.jpg")
...
CODE = (environ.get('CODE', 'https://graph.org/file/aded04b556637b6137948-7fff59382356c9f03a.jpg')) # Scanner Code image 
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001641766504').split()]
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "hhttps://t.me/filmy_men")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'filmy_men')
